...
CREATE TABLE headspace_post_index (keyword VARCHAR(200), field VARCHAR(50), position BIGINT, id BIGINT, PRIMARY KEY(keyword, field, position, id)) ENGINE = INNODB;
CREATE TABLE headspace_post (id BIGINT AUTO_INCREMENT, network_id BIGINT, networkuser_id BIGINT, subject VARCHAR(255), body VARCHAR(255), html_body VARCHAR(255), allow_comments BIGINT, status BIGINT DEFAULT 1, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, slug VARCHAR(255), UNIQUE INDEX headspace_post_sluggable_idx (slug), INDEX network_id_idx (network_id), INDEX networkuser_id_idx (networkuser_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE headspace_post_tag (id BIGINT AUTO_INCREMENT, post_id BIGINT, tag_id BIGINT, INDEX tag_id_idx (tag_id), INDEX post_id_idx (post_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE headspace_tag_index (keyword VARCHAR(200), field VARCHAR(50), position BIGINT, id BIGINT, PRIMARY KEY(keyword, field, position, id)) ENGINE = INNODB;
CREATE TABLE headspace_tag (id BIGINT AUTO_INCREMENT, network_id BIGINT, networkuser_id BIGINT, count BIGINT DEFAULT 0, tag VARCHAR(20), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX network_id_idx (network_id), INDEX networkuser_id_idx (networkuser_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE message (id BIGINT AUTO_INCREMENT, subject VARCHAR(100), body VARCHAR(255), htmlbody VARCHAR(255), user_id BIGINT, network_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), INDEX network_id_idx (network_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE message_reciever (id BIGINT AUTO_INCREMENT, message_id BIGINT, user_id BIGINT, messagestatus_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), INDEX message_id_idx (message_id), INDEX messagestatus_id_idx (messagestatus_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE notification (id BIGINT AUTO_INCREMENT, network_id BIGINT, user_id BIGINT, description VARCHAR(255), notificationtype_id BIGINT, lasttime_read DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX network_id_idx (network_id), INDEX user_id_idx (user_id), INDEX notificationtype_id_idx (notificationtype_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE notification_type (id BIGINT AUTO_INCREMENT, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE photo (id BIGINT AUTO_INCREMENT, url VARCHAR(100), network_id BIGINT, user_id BIGINT, view_count BIGINT DEFAULT 0, is_private TINYINT(1) DEFAULT '0', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), INDEX network_id_idx (network_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE photo_gallery (id BIGINT AUTO_INCREMENT, title VARCHAR(200), network_id BIGINT, user_id BIGINT, photo_count BIGINT DEFAULT 0, is_private TINYINT(1) DEFAULT '0', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), INDEX network_id_idx (network_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE speakout_reply_index (keyword VARCHAR(200), field VARCHAR(50), position BIGINT, id BIGINT, PRIMARY KEY(keyword, field, position, id)) ENGINE = INNODB;
CREATE TABLE speakout_reply (id BIGINT AUTO_INCREMENT, body VARCHAR(255), htmlbody VARCHAR(255), topic_id BIGINT, network_id BIGINT, user_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME, INDEX topic_id_idx (topic_id), INDEX network_id_idx (network_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE speakout_topic (id BIGINT AUTO_INCREMENT, title VARCHAR(200), description VARCHAR(200), category_id BIGINT, network_id BIGINT, user_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME, INDEX category_id_idx (category_id), INDEX network_id_idx (network_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user_profile (id BIGINT AUTO_INCREMENT, sfuser_id BIGINT, mobile_no VARCHAR(255), description VARCHAR(255), profile_pic VARCHAR(255) DEFAULT 'default_profile_pic.gif', gender_id BIGINT, city VARCHAR(255), country VARCHAR(255), birthday DATETIME NOT NULL, is_private TINYINT(1) DEFAULT '0', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX sfuser_id_idx (sfuser_id), INDEX gender_id_idx (gender_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE headspace_comment ADD CONSTRAINT headspace_comment_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
ALTER TABLE headspace_post_index ADD CONSTRAINT headspace_post_index_id_headspace_post_id FOREIGN KEY (id) REFERENCES headspace_post(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE headspace_post ADD CONSTRAINT headspace_post_networkuser_id_network_user_id FOREIGN KEY (networkuser_id) REFERENCES network_user(id);
ALTER TABLE headspace_post ADD CONSTRAINT headspace_post_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
ALTER TABLE headspace_post_tag ADD CONSTRAINT headspace_post_tag_tag_id_headspace_tag_id FOREIGN KEY (tag_id) REFERENCES headspace_tag(id) ON DELETE CASCADE;
ALTER TABLE headspace_post_tag ADD CONSTRAINT headspace_post_tag_post_id_headspace_post_id FOREIGN KEY (post_id) REFERENCES headspace_post(id) ON DELETE CASCADE;
ALTER TABLE headspace_tag_index ADD CONSTRAINT headspace_tag_index_id_headspace_tag_id FOREIGN KEY (id) REFERENCES headspace_tag(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE headspace_tag ADD CONSTRAINT headspace_tag_networkuser_id_network_user_id FOREIGN KEY (networkuser_id) REFERENCES network_user(id);
ALTER TABLE headspace_tag ADD CONSTRAINT headspace_tag_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
...
ALTER TABLE message_reciever ADD CONSTRAINT message_reciever_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id);
...
ALTER TABLE photo ADD CONSTRAINT photo_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id);
ALTER TABLE photo ADD CONSTRAINT photo_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
ALTER TABLE photo_gallery ADD CONSTRAINT photo_gallery_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id);
ALTER TABLE photo_gallery ADD CONSTRAINT photo_gallery_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
...
ALTER TABLE speakout_reply_index ADD CONSTRAINT speakout_reply_index_id_speakout_reply_id FOREIGN KEY (id) REFERENCES speakout_reply(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE speakout_reply ADD CONSTRAINT speakout_reply_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id);
...
ALTER TABLE speakout_reply ADD CONSTRAINT speakout_reply_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
...
ALTER TABLE speakout_topic ADD CONSTRAINT speakout_topic_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id);
ALTER TABLE speakout_topic ADD CONSTRAINT speakout_topic_network_id_network_id FOREIGN KEY (network_id) REFERENCES network(id);
