...
/**
 * WebuyNetworkUser filter form base class.
 *
 * @package    Spark
 * @subpackage filter
 ...
 */
abstract class BaseWebuyNetworkUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('webuy_network_user_filters[%s]');
