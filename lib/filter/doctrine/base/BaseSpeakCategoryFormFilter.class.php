...
/**
 * SpeakCategory filter form base class.
 *
 * @package    Spark
 * @subpackage filter
 ...
 */
abstract class BaseSpeakCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('speak_category_filters[%s]');
