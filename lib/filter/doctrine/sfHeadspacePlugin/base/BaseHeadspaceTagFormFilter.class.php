...
/**
 * HeadspaceTag filter form base class.
 *
 * @package    Yuoweb
 * @subpackage filter
 ...
 */
abstract class BaseHeadspaceTagFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('headspace_tag_filters[%s]');
