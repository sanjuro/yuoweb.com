...
/**
 * EventIndex form base class.
 *
 * @method EventIndex getObject() Returns the current form's model object
 *
 * @package    Spark
 * @subpackage form
 ...
 */
abstract class BaseEventIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('event_index[%s]');
