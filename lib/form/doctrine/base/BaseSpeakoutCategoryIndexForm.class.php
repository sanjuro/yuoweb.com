...
/**
 * SpeakoutCategoryIndex form base class.
 *
 * @method SpeakoutCategoryIndex getObject() Returns the current form's model object
 *
 * @package    Spark
 * @subpackage form
 ...
 */
abstract class BaseSpeakoutCategoryIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('speakout_category_index[%s]');
