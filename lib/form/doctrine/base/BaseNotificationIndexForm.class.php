...
/**
 * NotificationIndex form base class.
 *
 * @method NotificationIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseNotificationIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('notification_index[%s]');
