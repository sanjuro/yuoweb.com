...
/**
 * ShoutMessageIndex form base class.
 *
 * @method ShoutMessageIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseShoutMessageIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('shout_message_index[%s]');
