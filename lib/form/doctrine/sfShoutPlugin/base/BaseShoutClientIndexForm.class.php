...
/**
 * ShoutClientIndex form base class.
 *
 * @method ShoutClientIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseShoutClientIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('shout_client_index[%s]');
