...
/**
 * WebuyDealIndex form base class.
 *
 * @method WebuyDealIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseWebuyDealIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('webuy_deal_index[%s]');
