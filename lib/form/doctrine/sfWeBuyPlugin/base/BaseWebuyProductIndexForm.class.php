...
/**
 * WebuyProductIndex form base class.
 *
 * @method WebuyProductIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseWebuyProductIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('webuy_product_index[%s]');
