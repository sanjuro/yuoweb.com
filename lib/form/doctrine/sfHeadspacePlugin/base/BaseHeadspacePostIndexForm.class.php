...
/**
 * HeadspacePostIndex form base class.
 *
 * @method HeadspacePostIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseHeadspacePostIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('headspace_post_index[%s]');
