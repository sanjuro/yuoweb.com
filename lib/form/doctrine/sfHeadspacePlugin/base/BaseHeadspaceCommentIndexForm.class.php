...
/**
 * HeadspaceCommentIndex form base class.
 *
 * @method HeadspaceCommentIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseHeadspaceCommentIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('headspace_comment_index[%s]');
