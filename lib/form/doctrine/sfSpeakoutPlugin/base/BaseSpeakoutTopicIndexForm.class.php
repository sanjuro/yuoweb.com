...
/**
 * SpeakoutTopicIndex form base class.
 *
 * @method SpeakoutTopicIndex getObject() Returns the current form's model object
 *
 * @package    Yuoweb
 * @subpackage form
 ...
 */
abstract class BaseSpeakoutTopicIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('speakout_topic_index[%s]');
