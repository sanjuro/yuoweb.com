...
<?php slot( 'pagetitle', '<h1>Login</h1>' )?>

<form action="<?php echo url_for('network_signin', $network) ?>" method="post">
 ...
 <?php echo link_to(__('Join this network'),url_for( 'user_join', $network ))?>
 <div class="clearer" style="height:20px;"></div>
  </fieldset>
</form>
